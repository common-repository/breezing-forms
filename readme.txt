...
Donate link: https://crosstec.org/en/downloads/wordpress-forms.html
Tags:  form builder, forms, contact form, email form
...
[Pro Version](https://crosstec.org/en/downloads/wordpress-forms.html) |
[Demo Forms](https://crosstec.org/breezingformsdemo/index.php/breezingforms-demos/bootstrap-based-forms/all-elements.html) |
...
See the [demo forms](https://crosstec.org/breezingformsdemo/index.php/breezingforms-demos/bootstrap-based-forms/all-elements.html) for a some examples and you will get an idea of what is possible.

All kinds of forms are possible: [contact forms](https://crosstec.org/en/downloads/wordpress-forms.html), job application forms, feedback forms, order forms, questionnaires, payments, pay to download files and anything else you can think of that requires to collect data from your visitors.
...
* Business/CRM: Salesforce® integration
...
***If you got any questions on the pro, please don't hesitate to contact us at <support@crosstec.org>***
 ...
 * Fixed a form import issue with forms being exported from Joomla

= 1.2.8.* =
 * Major update, fixing installation and PHP 7.2+ issues

= 1.2.7.42 =
 * removed packaged PHPMailer instance as of WordPress' suggestion. Now using WordPress' instance, which is in synch with security updates.

= 1.2.7.39 =
 * fixed issues upon importing forms

= 1.2.7.39 =
 * fixed some php7 related problems, email sending issues and deprecated warnings
