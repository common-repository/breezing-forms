...
class facileFormsInstaller
{
	...
	public static function chmodRecursive($path, $filemode=NULL, $dirmode=NULL)
	{
		$ret = TRUE;
		if (is_dir($path)) {
			$dh = opendir($path);
	...
	public static function testdb($table, $column)
	{
		global $database;
	...
	public static function step2($option)
	{
	...
	public static function step3($option)
	{
		...
		if ($ff_config->uploads == '{mospath}/media/breezingforms/uploads')
			$ff_config->uploads = '{contentdir}/breezingforms/uploads';
                if ($ff_config->uploads == '{contentdir}/breezingforms/uploads')
			$ff_config->uploads = '{contentdir}/breezingforms/uploads';
		$ff_config->store();
