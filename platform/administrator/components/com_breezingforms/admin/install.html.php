...
{
	public static function step2($option, $release)
	{
?>
		...
		<form action="admin.php?page=breezingforms" method="post" name="adminForm" id="adminForm" class="adminForm">
			...
			<tr>
				...
				<td nowrap style="text-align:right">
					<button class="button-primary" onclick="submitbutton('step3');"><?php echo BFText::_('COM_BREEZINGFORMS_TOOLBAR_CONTINUE'); ?></button>
				</td>
				<td></td>
			</tr>
		</table>
...
<?php
	...
	public static function step3($option, &$errors)
	{
?>
		<table cellpadding="4" cellspacing="1" border="0" class="adminform" style="width:450px;">
		<form action="admin.php?page=breezingforms" method="post" name="adminForm" id="adminForm" class="adminForm">
...
?>
			...
			<tr>
				<td></td>
				<td nowrap style="text-align:right">
                                        <button class="button-primary" onclick="submitbutton('step4');"><?php echo BFText::_('COM_BREEZINGFORMS_TOOLBAR_CONTINUE'); ?></button>
				</td>
				<td></td>
			</tr>
		</table>
