                                                                    ...
                                                                    if(trim($sub->value)){
                                                                        ...
                                                                        foreach($files As $file){
                                                                            if(!JFile::exists($file)){
                                                                                ...
                                                                                $this->renderFile($file, $sub->id, $sub->element, $fileIdx);
                                                                            }
                                                                            echo '<br/>';
                                                                            $fileIdx++;
                                                                        }
...
<div id="editcell">
    ...
    {
        $row = $rows[$i];
        if ($row->viewed) $view_src = BF_PLUGINS_URL . "/".BF_FOLDER."/platform/administrator/components/com_breezingforms/images/icons/publish_g.png"; else $view_src = BF_PLUGINS_URL . "/".BF_FOLDER."/platform/administrator/components/com_breezingforms/images/icons/publish_x.png";
	if ($row->exported) $exp_src = BF_PLUGINS_URL . "/".BF_FOLDER."/platform/administrator/components/com_breezingforms/images/icons/publish_g.png"; else $exp_src = BF_PLUGINS_URL . "/".BF_FOLDER."/platform/administrator/components/com_breezingforms/images/icons/publish_x.png";
	if ($row->archived) $arch_src = BF_PLUGINS_URL . "/".BF_FOLDER."/platform/administrator/components/com_breezingforms/images/icons/publish_g.png"; else $arch_src = BF_PLUGINS_URL . "/".BF_FOLDER."/platform/administrator/components/com_breezingforms/images/icons/publish_x.png";
        ?>
