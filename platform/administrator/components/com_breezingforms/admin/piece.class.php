...
class facileFormsPiece
{
	...
	function save($option, $pkg)
	{
		...
		JFactory::getApplication()->redirect(
			"admin.php?page=breezingforms&act=managepieces&pkg=$pkg",
			BFText::_('COM_BREEZINGFORMS_PIECES_SAVED'));
	} // save

	public static function cancel($option, $pkg)
	{
		JFactory::getApplication()->redirect("admin.php?page=breezingforms&act=managepieces&pkg=$pkg");
	} // cancel
	...
	public static function copy($option, $pkg, $ids)
	{
		...
		JFactory::getApplication()->redirect("admin.php?page=breezingforms&act=managepieces&pkg=$pkg&mosmsg=$msg");
	} // copy
