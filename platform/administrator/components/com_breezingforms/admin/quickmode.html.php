...
?>              
	...
	<link rel="stylesheet" type="text/css" href="<?php echo WP_PLUGIN_URL;?>/<?php echo BF_FOLDER;?>/platform/administrator/components/com_breezingforms/libraries/jquery/themes/quickmode/quickmode.all.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo WP_PLUGIN_URL;?>/<?php echo BF_FOLDER;?>/platform/administrator/components/com_breezingforms/libraries/jquery/jtree/tree_component.css" />
        
        <script type="text/javascript" src="<?php echo WP_PLUGIN_URL . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/jtree/' ;?>_lib.js"></script>	
	<script type="text/javascript" src="<?php echo WP_PLUGIN_URL . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/jtree/' ;?>tree_component.js"></script>
	<script
	type="text/javascript"
	src="<?php echo WP_PLUGIN_URL . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/' ;?>jq-ui.min.js"></script>
	<script
	type="text/javascript"
	src="<?php echo WP_PLUGIN_URL . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/plugins/' ;?>base64.js"></script>
	<script
	type="text/javascript"
	src="<?php echo WP_PLUGIN_URL . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/plugins/' ;?>json.js"></script>
	<script
	type="text/javascript"
	src="<?php echo WP_PLUGIN_URL . '/'.BF_FOLDER.'/platform/administrator/components/com_breezingforms/libraries/jquery/plugins/' ;?>md5.js"></script>
        <script
	type="text/javascript"
	src="<?php echo WP_PLUGIN_URL;?>/<?php echo BF_FOLDER;?>/platform/administrator/components/com_breezingforms/libraries/jquery/center.js"></script>
		            	...
		            	<div class="bfProperties" id="bfElementProperties" style="display:none">
		            		...
		            		<fieldset>
		            			...
		            			<div class="bfElementTypeClass" id="bfElementTypeReCaptcha" style="display:none">
				            		...
				            		<input type="text" value="" id="bfElementTypeReCaptchaTheme" placeholder="Type 'invisible' or 'insivible_inline' for invisible reCaptcha"/>
                                                        <br/>
		            				<br/>
