...
class JSession extends JObject
{
    ...
    {
        if(!isset($_SESSION[$namespace . '__' . $name])){
            return $default;
        }
        return $_SESSION[$namespace . '__' . $name];
    ...
    public function set($name, $value = null, $namespace = 'default')
    {
        $old = null;
        if(isset($_SESSION[$namespace . '__' . $name])){
            $old = $_SESSION[$namespace . '__' . $name];
        }
        $_SESSION[$namespace . '__' . $name] = $value;
        return $old;
	...
	{
		return isset($_SESSION[$namespace = '__' . $namespace]);
	...
	public function clear($name, $namespace = 'default')
	{
	    ...
	    unset($_SESSION[$namespace . '__' . $name]);
	    return $old;
