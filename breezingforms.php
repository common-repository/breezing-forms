...
Plugin URI:         https://crosstec.org/en/downloads/wordpress-forms.html
Description:        A professional wordpress forms plugin.
Version:            1.2.8.11
Requires at least:  3.0
Author:             Crosstec
Author URI:         https://crosstec.org/en/
License:            GPL2
*/
...
function breezingforms_admin_init(){
    //start_bf_session();
    add_menu_page('BreezingForms', 'BreezingForms', 'administrator', 'breezingforms', 'breezingforms_admin', BF_PLUGINS_URL . '/'.BF_FOLDER.'/breezingforms-icon.png');
...
add_action('send_headers', 'start_bf_session');
function start_bf_session() {
